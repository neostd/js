...
const lib = ffi.dlopen("advapi32.dll", {
  RegOpenKeyExW: { parameters: ["pointer", "pointer", "u32", "u32", "pointer"], result: "i32" },
  RegCreateKeyExW: {
    parameters: [
      "pointer",
      "pointer",
  ...
  RegDeleteKeyW: { parameters: ["pointer", "pointer"], result: "i32" },
  RegDeleteValueW: { parameters: ["pointer", "pointer"], result: "i32" },
  RegQueryInfoKeyW: {
    parameters: [
      "pointer",
      "pointer",
