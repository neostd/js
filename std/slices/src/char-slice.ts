...
import { endsWith, endsWithFold } from "./ends-with.ts";
import { startsWith, startsWithFold } from "./starts-with.ts";
import { indexOf, indexOfFold } from "./index-of.ts";
import { lastIndexOf, lastIndexOfFold } from "./last-index-of.ts";
 ...
 * ```
 */
export function readonlyCharSlice(
  buffer: Uint32Array | number[] | string,
  start?: number,
  end?: number,
): ReadonlyCharSlice {
