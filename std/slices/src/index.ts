 ...
 *
 * [![JSR](https://jsr.io/badges/@neostd/slices)](https://jsr.io/@neostd/slices)
 * [![npm version](https://badge.fury.io/js/@neostd%2Fslices.svg)](https://badge.fury.io/js/@neostd%2Fslices)
 * [![GitHub version](https://badge.fury.io/gh/neostd%2Fjs.svg)](https://badge.fury.io/gh/neostd%2Fjs)
 *
 * ## Documentation
 *
 * Documentation is available on [jsr.io](https://jsr.io/@neostd/slices/doc)
 *
 ...
 * ```bash
 * # Deno
 * deno add jsr:@neostd/slices
 *
 * # npm from jsr
 * npx jsr add @neostd/slices
 *
 * # from npmjs.org
 * npm install @neostd/slices
 * ```
 *
 * ## Usage
 *
 * ```typescript
 * import * from slices from '@neostd/slices'
 *
...
export * from "./char-array-builder.ts";
export * from "./char-slice.ts";
