 ...
 * @example
 * ```typescript
 * import { ordinalize } from '@neostd/slices/ordinalize';
 *
 * // Basic ordinals
  ...
  for (let i = 0; i < v.length; i++) {
    ...
    if (c >= 48 && c <= 57) {
      ...
      if (isSpace(c)) {
        ...
        let suffix = "th";
        if (last2 === 49 && last > 48 && last < 52) suffix = "th";
        else if (last === 49) suffix = "st";
        else if (last === 50) suffix = "nd";
        else if (last === 51) suffix = "rd";
