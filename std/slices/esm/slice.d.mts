 ...
 * ```
 */
declare class Slice<T> implements Iterable<T> {
  #private;
  /**
 ...
 * ```
 */
declare class ReadOnlySlice<T> implements Iterable<T> {
  #private;
  /**
...
declare function slice<T>(array: Array<T>, offset?: number, length?: number): Slice<T>;
declare function readOnlySlice<T>(
  array: Array<T>,
  offset?: number,
  length?: number,
): ReadOnlySlice<T>;
