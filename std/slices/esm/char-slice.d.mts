import { CharBuffer, CharSequence, CharSliceLike } from "./utils.mjs";

//#region src/char-slice.d.ts
/**
 ...
 */
declare class ReadonlyCharSlice implements CharSequence, Iterable<number> {
  #private;
  /**
 ...
 * ```
 */
declare class CharSlice implements CharSequence, Iterable<number> {
  #private;
  /**
 ...
 * ```
 */
declare function readonlyCharSlice(
  buffer: Uint32Array | number[] | string,
  start?: number,
  end?: number,
): ReadonlyCharSlice;
