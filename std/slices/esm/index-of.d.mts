 ...
 * ```
 */
declare function indexOfFold(value: CharBuffer, test: CharBuffer, index?: number): number;
/**
 * Finds the first occurrence of a substring in a character buffer using
 ...
 * ```
 */
declare function indexOf(value: CharBuffer, test: CharBuffer, index?: number): number;
//#endregion
