 ...
 * ```
 */
declare function trimEndSpace(buffer: CharBuffer): Uint32Array;
/**
 ...
 * ```
 */
declare function trimEndChar(buffer: CharBuffer, suffix: number): Uint32Array;
/**
 ...
 * ```
 */
declare function trimEndSlice(buffer: CharBuffer, suffix: CharBuffer): Uint32Array;
/**
 ...
 * ```
 */
declare function trimEnd(buffer: CharBuffer, suffix?: CharBuffer): Uint32Array;
/**
 ...
 * ```
 */
declare function trimStartSpace(buffer: CharBuffer): Uint32Array;
/**
 ...
 * ```
 */
declare function trimStartChar(buffer: CharBuffer, prefix: number): Uint32Array;
/**
 ...
 * ```
 */
declare function trimStartSlice(buffer: CharBuffer, prefix: CharBuffer): Uint32Array;
/**
 ...
 * ```
 */
declare function trimStart(buffer: CharBuffer, prefix?: CharBuffer): Uint32Array;
/**
 ...
 * ```
 */
declare function trimSpace(buffer: CharBuffer): Uint32Array;
/**
 ...
 * ```
 */
declare function trimChar(buffer: CharBuffer, prefix: number): Uint32Array;
/**
 ...
 * ```
 */
declare function trimSlice(buffer: CharBuffer, chars: CharBuffer): Uint32Array;
/**
 ...
 * ```
 */
declare function trim(buffer: CharBuffer, chars?: CharBuffer): Uint32Array;
//#endregion
export {
  trim,
  trimChar,
