 ...
 */
interface CharSequence extends CharSliceLike {
 ...
 */
type CharBuffer = string | Uint32Array | Uint16Array | Uint8Array | CharSequence;
/**
 ...
 * @returns The slice.
 */
declare function toCharSliceLike(buffer: CharBuffer): CharSliceLike;
//#endregion
export { CharBuffer, CharSequence, CharSliceLike, toCharArray, toCharSliceLike, toString };
