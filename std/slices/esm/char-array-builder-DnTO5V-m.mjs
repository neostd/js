...
//#endregion
//#region src/char-array-builder.ts
/**
...
var CharArrayBuilder = class {
  ...
  append(value) {
    const v = value;
    if (v.length !== void 0 && v.at !== void 0) this.appendSlice(v);
    else
      switch (typeof value) {
        case "string":
          this.appendString(v);
        ...
        case "boolean":
          ...
          break;
        case "object":
          if (v instanceof Date) this.appendString(v.toString());
          else throw new RangeError("Argument 'value' is not a valid type.");
          break;
        default:
   ...
   */
  appendChar(value) {
    if (!Number.isInteger(value) || value < 0 || value > 1114111)
   ...
   */
  appendLine(value) {
    if (value !== void 0 && value.length > 0) this.appendSlice(value);
    if (WINDOWS) this.appendChar(13);
    this.appendChar(10);
    return this;
  }
  /**
   ...
   */
  shrinkTo(capacity) {
    if (capacity < 0) throw new RangeError("Argument 'capacity' must be greater than -1.");
   ...
   */
  grow(capacity) {
    if (capacity <= this.#buffer.length) return this;
