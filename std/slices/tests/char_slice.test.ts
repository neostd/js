...
import { deepEqual as equal, ok, throws } from "node:assert/strict";
import { CharSlice, ReadonlyCharSlice } from "../src/char-slice.ts";
import { toCharArray } from "../src/utils.ts";
