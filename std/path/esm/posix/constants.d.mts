//#region src/posix/constants.d.ts
/**
 * The character used to separate entries in the PATH environment variable.
 *
 * @example
 * ```typescript
 * import { DELIMITER } from "@neostd/path/posix/constants";
 *
 ...
 * @example
 * ```typescript
 * import { SEPARATOR } from "@neostd/path/posix/constants";
 *
 ...
 * @example
 * ```typescript
 * import { SEPARATOR_PATTERN } from "@neostd/path/posix/constants";
 *
