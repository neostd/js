...
import { dirname } from "../src/dirname.ts";
import * as posix from "../src/posix/index.ts";
import * as windows from "../src/windows/index.ts";
import { dirname as windowsUnstableDirname } from "../src/windows/dirname.ts";
import { dirname as posixUnstableDirname } from "../src/posix/dirname.ts";
