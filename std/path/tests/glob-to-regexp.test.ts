...
import { type GlobOptions, globToRegExp } from "../src/glob-to-regexp.ts";
import { globToRegExp as posixGlobToRegExp } from "../src/posix/glob-to-regexp.ts";
import { globToRegExp as windowsGlobToRegExp } from "../src/windows/glob-to-regexp.ts";
