...
import { basename } from "../src/basename.ts";
import * as posix from "../src/posix/index.ts";
import * as windows from "../src/windows/index.ts";
import { basename as posixUnstableBasename } from "../src/posix/basename.ts";
import { basename as windowsUnstableBasename } from "../src/windows/basename.ts";
