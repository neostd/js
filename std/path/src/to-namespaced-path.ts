...
import { toNamespacedPath as posixToNamespacedPath } from "./posix/to-namespaced-path.ts";
import { toNamespacedPath as windowsToNamespacedPath } from "./windows/to-namespaced-path.ts";
