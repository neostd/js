 ...
 * such as deno, bun, and node. Command substitution executes commands
 * directly by default, or through PowerShell on Windows and Bash elsewhere
 * when `useShell` is enabled.
 *
 ...
 * }
 *
 * const o5 = env.expand(`use command substitution: $(node --version)`, { commandSubstitution: true });
 * console.log(o5); // use command substitution: v22.0.0
 *
