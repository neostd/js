import { r as SubstitutionOptions } from "./expand-BmGiuZEn.mjs";
...
type EnvProxy = Record<string, string | undefined>;
/**
 ...
 * ```
 */
declare function set(name: string, value: string): void;
/**
 ...
 * ```
 */
declare function toObject(): Record<string, string | undefined>;
/**
 ...
 * ```
 */
declare function merge(values: Record<string, string | undefined | null>): void;
/**
 ...
 * ```
 */
declare function union(values: Record<string, string | undefined>): void;
/**
 ...
 * ```
 */
declare function setPath(value: string): void;
/**
 ...
 * ```
 */
declare function hasPath(value: string, paths?: string[]): boolean;
/**
 ...
 * ```
 */
declare function splitPath(paths?: string): string[];
/**
 ...
 * ```
 */
declare function appendPath(path: string, force?: boolean): void;
/**
 ...
 * ```
 */
declare function prependPath(path: string, force?: boolean): void;
/**
 ...
 * ```
 */
declare function removePath(path: string): void;
/**
 ...
 * ```
 */
declare function replacePath(oldPath: string, newPath: string): void;
/**
 ...
 * ```
 */
declare function home(): string | undefined;
/**
 ...
 * ```
 */
declare function user(): string | undefined;
/**
 ...
 * ```
 */
declare function shell(): string | undefined;
/**
 ...
 * ```
 */
declare function hostname(): string | undefined;
/**
 ...
 * ```
 */
declare function os(): string | undefined;
//#endregion
export {
  toObject as C,
  splitPath as S,
