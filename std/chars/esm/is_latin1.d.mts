 ...
 * @example
 * ```typescript
 * import { isLatin1 } from '@neostd/chars/is-latin1';
 *
 ...
 * ```
 */
declare function isLatin1(value: number): boolean;
/**
 ...
 * @example
 * ```typescript
 * import { isLatin1At } from "@neostd/chars/is";
 *
 ...
 * ```
 */
declare function isLatin1At(value: string, index: number): boolean;
//#endregion
export { isLatin1, isLatin1At };