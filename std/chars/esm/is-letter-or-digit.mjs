import { isDigit, isDigitUnsafe } from "./is-digit.mjs";
import { isLetter, isLetterUnsafe } from "./is-letter.mjs";
//#region src/is-letter-or-digit.ts
/**
 ...
 * @example
 * ```ts
 * import { isLetterOrDigit } from "@neostd/chars/is-letter-or-digit";
 *
 ...
 * @example
 * ```ts
 * import { isLetterOrDigitUnsafe } from "@neostd/chars/is-letter-or-digit";
 *
 ...
 * ```
 */
function isLetterOrDigitUnsafe(char) {
 ...
 * @example
 * ```ts
 * import { isLetterOrDigitAt } from "@neostd/chars/is-letter-or-digit";
 *
 ...
 * ```
 */
function isLetterOrDigitAt(str, index) {
  return isLetterOrDigitUnsafe(str.codePointAt(index) ?? 0);
}
//#endregion
export { isLetterOrDigit, isLetterOrDigitAt, isLetterOrDigitUnsafe };
