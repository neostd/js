 ...
 * ```
 */
declare function isSpace(char: Char): boolean;
/**
 * Checks if the given character is a whitespace character.
 * @param char The character to check.
 * @returns `true` if the character is a whitespace character, `false` otherwise.
 ...
 * ```
 */
declare function isSpaceUnsafe(char: Char): boolean;
/**
 ...
 * ```
 */
declare function isSpaceAt(value: string, index: number): boolean;
//#endregion
