...
//#region src/is_letter_or_digit.d.ts
/**
 ...
 * ```
 */
declare function isLetterOrDigit(char: Char): boolean;
/**
 * Determines whether the given character is a letter or digit.
 *
 * @description
 ...
 * ```
 */
declare function isLetterOrDigitUnsafe(char: Char): boolean;
/**
 ...
 * ```
 */
declare function isLetterOrDigitAt(str: string, index: number): boolean;
//#endregion
