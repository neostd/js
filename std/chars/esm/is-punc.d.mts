 ...
 * ```
 */
declare function isPunc(char: Char): boolean;
/**
 ...
 * ```
 */
declare function isPuncUnsafe(char: Char): boolean;
/**
 ...
 * ```
 */
declare function isPuncAt(str: string, index: number): boolean;
//#endregion
