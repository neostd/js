...
* ## Documentation
*
* Documentation is available on [jsr.io](https://jsr.io/@neostd/chars/doc)
*
...
* ```bash
* # Deno
* deno add jsr:@neostd/chars
*
* # npm from jsr
* npx jsr add @neostd/chars
*
* # from npmjs.org
* npm install @neostd/chars
* ```
*
* ## Usage
*
...
//#endregion
export { src_default as default, equalFold, isAscii, isChar, isControl, isDigit, isLatin1, isLetter, isLetterOrDigit, isLower, isPunc, isSpace, isSymbol, isUpper, simpleFold, toLower, toUpper };
