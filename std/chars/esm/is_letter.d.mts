 ...
 * ```
 */
declare function isLetter(char: Char): boolean;
/**
 * Checks if the given value represents a letter.
 *
 * @description
 ...
 * ```
 */
declare function isLetterUnsafe(char: Char): boolean;
/**
 ...
 * ```
 */
declare function isLetterAt(value: string, index: number): boolean;
//#endregion
